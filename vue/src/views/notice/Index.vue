  ...
  <el-row class="search-row">
    ...
    <div class="search-item">
      ...
      <div style="width: 222px">
        <el-date-picker placeholder="发布时间起始" value-format="YYYY-MM-DD" v-model="searchForm.createtimeL" type="date" :shortcuts="shortcuts"/>
      </div>
      <span>至</span>
      <div style="width: 222px">
        <el-date-picker placeholder="发布时间结束" value-format="YYYY-MM-DD" v-model="searchForm.createtimeR" type="date" :shortcuts="shortcuts"/>
      </div>
    </div>
