  ...
  <el-table :data="pager.records" style="width: 100%">
    ...
    <el-table-column fixed="right" label="操作">
      <template #default="scope">
        ...
        <button class="x-btn x-btn-warn" v-if=" user.role.toLowerCase() == ''  " @click="onEdit(scope.row.id)">编辑</button>
        <button class="x-btn x-btn-error" v-if="  user.role.toLowerCase() == ''  " @click="onDelete(scope.row.id)">删除</button>
